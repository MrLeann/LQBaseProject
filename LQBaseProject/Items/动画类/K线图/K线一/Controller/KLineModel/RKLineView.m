...
-(void)updateNib{
    ...
    if (movelineone==Nil) {
        ...
        movelineone.backgroundColor = [UIColor mColorWithHexString:@"#333333" withAlpha:0.5];
    ...
    if (movelinetwo==Nil) {
        ...
        movelinetwo.backgroundColor = [UIColor mColorWithHexString:@"#333333" withAlpha:0.5];
    ...
    if (xxView==Nil) {
        ...
        xxView.backgroundColor = [UIColor mColorWithHexString:@"#333333" withAlpha:1];
        xxView.hidden = YES;
    ...
    if (movelinetwoLable==Nil) {
        ...
        movelinetwoLable.backgroundColor = [UIColor mColorWithHexString:@"#333333" withAlpha:1];
...
-(void)drawBox{
    ...
    if (mainboxView==nil) {
        ...
        mainboxView.layer.borderColor = [UIColor mColorWithHexString:@"#444444" withAlpha:0.5].CGColor;
    ...
    if (MA5==nil) {
        ...
        MA5.text = @"MA5";
        MA5.textColor = [UIColor mColorWithHexString:@"#d83dd9" withAlpha:1];
        [MA5 sizeToFit];
        [self addSubview:MA5];
    }
    ...
    if (MA10==nil) {
        ...
        MA10.text = @"MA10";
        MA10.textColor = [UIColor mColorWithHexString:@"#ebac31" withAlpha:1];
        [MA10 sizeToFit];
    ...
    if (MA20==nil) {
        ...
        MA20.text = @"MA20";
        MA20.textColor = [UIColor mColorWithHexString:@"#2e87e2" withAlpha:1];
        [MA20 sizeToFit];
    ...
    if (bottomBoxView==nil) {
        ...
        bottomBoxView.layer.borderColor = [UIColor mColorWithHexString:@"#444444" withAlpha:0.5].CGColor;
...
-(void)drawBoxWithKline{
    ...
    shou1.text = [ToolClass mChangePrice:getdata.volMaxValue];
    shou2.text = [ToolClass mChangePrice:getdata.volMaxValue/3*2];
    shou3.text = [ToolClass mChangePrice:getdata.volMaxValue/3];
...
-(void)isKPointWithPoint:(CGPoint)point{
    ...
    for (NSArray *item in pointArray) {
        ...
        if (itemX==pointX || point.x-itemX<=self.kLineWidth/2) {
            ...
            cjlLable.text =[NSString stringWithFormat:@"成交量:%@",[ToolClass mChangePrice:[[item objectAtIndex:12]floatValue]]];
            cjeLable.text =[NSString stringWithFormat:@"成交额:%@",[ToolClass mChangePrice:[[item objectAtIndex:13]floatValue]]];
